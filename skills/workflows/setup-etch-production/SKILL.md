...
description: configure a repository for the v0.2 website production system by verifying wordpress, etch, automatic.css, browser, image-generation, tracker, environment, deployment, and rollback capabilities and creating or reconciling the durable product, site, design, delivery, evidence, and component artifacts.
